class Vendedor < ApplicationRecord
    ...
    validates :Nombre, format: { with: /\A[a-zA-Z]+(?:[\s-]*[a-zA-Z]+)?+(?:[\s-]*[a-zA-Z]+)?\z/, message: "solo acepta letras y maximo 3 palabras" }
    validates :Apellido_Paterno, :Apellido_Materno, format: { with: /\A[a-zA-Z]+(?:[\s-]*[a-zA-Z]+)?\z/, message: "solo acepta letras y maximo 2 palabras" }
