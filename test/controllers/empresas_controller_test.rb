...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { codigo: @empresa.codigo, direccion: @empresa.direccion, nombre: @empresa.nombre, telefono: @empresa.telefono } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { codigo: @empresa.codigo, direccion: @empresa.direccion, nombre: @empresa.nombre, telefono: @empresa.telefono } }
