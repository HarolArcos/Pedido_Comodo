...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference("Usuario.count") do
      post usuarios_url, params: { usuario: { Codigo: @usuario.Codigo, Mail: @usuario.Mail, tipo: @usuario.tipo } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { Codigo: @usuario.Codigo, Mail: @usuario.Mail, tipo: @usuario.tipo } }
